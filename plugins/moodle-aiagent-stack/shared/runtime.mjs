...
export const TOOL_ACTIONS = {
  ...
  moodle_questionbank: ["categories", "search", "search_details", "tags", "tags_sync", "pick_random", "render_html"],
  moodle_quiz: [
    "list",
    "create_practice",
    "resolve_random",
...
export const TOOL_DESCRIPTIONS = {
  ...
  moodle_questionbank:
    "Read Moodle question-bank categories, search questions, search-and-render one page with answers and feedback, indexed tags, pick random questions, and render question HTML. tags_sync rebuilds the local tag index but does not change Moodle question tags.",
  moodle_quiz:
