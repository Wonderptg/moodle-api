...
$functions = [
    ...
    'local_mathstate_lesson_start' => [
        'classname' => 'local_mathstate_external',
        'methodname' => 'lesson_start',
        'classpath' => 'local/mathstate/externallib.php',
        'description' => 'Start (or resume) one lesson session for the current user.',
        'type' => 'write',
        'capabilities' => 'local/mathstate:view, moodle/course:view',
    ],
    'local_mathstate_lesson_finish' => [
        'classname' => 'local_mathstate_external',
        'methodname' => 'lesson_finish',
        'classpath' => 'local/mathstate/externallib.php',
        'description' => 'Finish one lesson session for the current user.',
        'type' => 'write',
        'capabilities' => 'local/mathstate:view, moodle/course:view',
    ],
    'local_mathstate_lesson_log_append' => [
        'classname' => 'local_mathstate_external',
        'methodname' => 'lesson_log_append',
        'classpath' => 'local/mathstate/externallib.php',
        'description' => 'Append one learning-event row for the current user.',
        'type' => 'write',
        'capabilities' => 'local/mathstate:view, moodle/course:view',
    ],
    'local_mathstate_review_complete' => [
        'classname' => 'local_mathstate_external',
        'methodname' => 'review_complete',
        'classpath' => 'local/mathstate/externallib.php',
        'description' => 'Mark one review task as done/skipped.',
        'type' => 'write',
        'capabilities' => 'local/mathstate:view, moodle/course:view',
    ],
    'local_mathstate_doc_publish_request' => [
        'classname' => 'local_mathstate_external',
        'methodname' => 'doc_publish_request',
        'classpath' => 'local/mathstate/externallib.php',
        'description' => 'Create one document publish request job.',
        'type' => 'write',
        'capabilities' => 'local/mathstate:view, moodle/course:view',
    ],
    'local_mathstate_next_recommendation' => [
        'classname' => 'local_mathstate_external',
        'methodname' => 'next_recommendation',
        'classpath' => 'local/mathstate/externallib.php',
        'description' => 'Get next study recommendations for one student and course.',
        'type' => 'read',
        'capabilities' => 'local/mathstate:view, moodle/course:view',
    ],
